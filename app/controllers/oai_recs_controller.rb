class OaiRecsController < ApplicationController
  ...
  private
    ...
    def oai_rec_params
      params.require(:oai_rec).permit(:title, :creator, :subject, :description, :publisher, :contributor, :date, :temporal, :type, :format, :spatial, :identifier, :source, :language, :relation, :coverage, :rights, :access_rights, :rights_holder)
    end
end
