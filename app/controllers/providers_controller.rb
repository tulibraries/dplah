class ProvidersController < ApplicationController
  ...
  private
    ...
    def provider_params
      params.require(:provider).permit(:name, :description, :endpoint_url, :email, :metadata_prefix, :set, :contributing_institution, :collection_name, :in_production, :new_contributing_institution)
    end
