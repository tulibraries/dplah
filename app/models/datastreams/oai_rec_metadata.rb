class Datastreams::OaiRecMetadata < ActiveFedora::OmDatastream
  ...
  set_terminology do |t|
    ...
    t.created(:index_as=>[:facetable, :sortable, :stored_searchable], :type=>:string)
    t.issued(:index_as=>[:facetable, :sortable, :stored_searchable], :type=>:string)
    t.available(:index_as=>[:facetable, :sortable, :stored_searchable], :type=>:string)
